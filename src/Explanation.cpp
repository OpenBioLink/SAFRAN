...
void Explanation::insertEntities(Index* index) {
...
void Explanation::insertRelations(Index* index) {
...
void Explanation::insertRules(RuleReader* rr, int relsize, ClusteringReader* cr) {
...
void Explanation::insertTask(int task_id, bool is_head, int relation_id, int entity_id) {
...
void Explanation::insertPrediction(int task_id, int entity_id, bool hit, double confidence) {
...
void Explanation::insertCluster(int task_id, int entity_id, int cluster_id, double confidence) {
...
void Explanation::insertRule_Cluster(int task_id, int entity_id, int cluster_id, int rule_id) {
...
void Explanation::insertRule_Entity(int rule_id, int task_id, int entity_id) {
    //std::cout << "Rule_Cluster " << task_id << " " << entity_id << " " << cluster_id << " " << rule_id << "\n";
...
void Explanation::checkErrorCode(int code, char* sql) {
    if (code != SQLITE_OK && code != SQLITE_DONE) {
        const char* err;
        if (this->db) {
            err = sqlite3_errmsg(this->db);

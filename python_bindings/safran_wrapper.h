...
public:
    ...
    // [(head, pred, tail, confidence, rule_id)]
    std::vector<std::pair<std::string, std::pair<std::string, std::pair<std::string, std::pair<float, int>>>>> query(const std::string & action, size_t k,
